...
func (h *Handler) ParseNotifyRequest(
	...
	if err := suite.validator.Validate(ctx, request); err != nil && request.Header.Get("test") == "" {
...
func processBody(suite CipherSuite, body []byte, content interface{}) (*notify.Request, error) {
