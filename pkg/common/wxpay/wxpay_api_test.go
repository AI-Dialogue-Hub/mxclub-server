...
func getInfoV2(t *testing.T) *payments.Transaction {
	...
	str := `{"appid": "wx9558d788c3884def", "mchid": "1680996035", "payer": {"openid": "oXCsa7RqLnjR77XJ4utPOqFYBWUU"}, "amount": {"total": 6800, "currency": "CNY", "payer_total": 6800, "payer_currency": "CNY"}, "attach": "自定义数据说明", "bank_type": "OTHERS", "trade_type": "JSAPI", "trade_state": "SUCCESS", "out_trade_no": "1726443700396380", "success_time": "2024-09-16T07:41:47+08:00", "transaction_id": "4200002446202409161647411257", "trade_state_desc": "支付成功"}`
